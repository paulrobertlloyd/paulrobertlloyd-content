...
- ![Original user journey for adding projects.](/media/projects/snyk/flow_before.png "The original project creation flow took users to a dead end that provided too many options."){.screenshot}
- ![Proposed user journey for adding projects.](/media/projects/snyk/flow_after.png "The revised journey closed the loop, and ensured the project overview page was the single place to view and manage a project."){.screenshot}
- ![Add repos screen.](/media/projects/snyk/add_repos.png "This also required the creation of a task focused screen for adding new repos to a project."){.screenshot}
  {.gallery}
