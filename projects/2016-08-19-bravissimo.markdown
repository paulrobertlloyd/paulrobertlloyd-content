...
- ![Page listing swimwear available for sale.](/media/projects/bravissimo/swimwear.png "Component preview and underlying code shown within Brastrap."){.screenshot}
- ![Product page.](/media/projects/bravissimo/product.png "Brastrap styleguide page detailing colour palettes."){.screenshot}
  {.gallery}
...
- ![Brastrap component page.](/media/projects/bravissimo/brastrap_component.png "Component preview and underlying code shown within Brastrap."){.screenshot}
- ![Brastrap styleguide page.](/media/projects/bravissimo/brastrap_palette.png "Brastrap styleguide page detailing colour palettes."){.screenshot}
  {.gallery}
