...
- ![Cover screen.](/media/projects/the_week/cover.png "Progression through an issue of the magazine; from cover…"){.screenshot}
- ![Politics index.](/media/projects/the_week/index.png "…to a section index…"){.screenshot}
  {.gallery}

![Screen showing the first page of the selected politics story.](/media/projects/the_week/article.png "…to individual article. Double tapping on an article screen would bring up the ‘scrubber’ enabling users to quickly advance through an issue."){.screenshot}
:::
