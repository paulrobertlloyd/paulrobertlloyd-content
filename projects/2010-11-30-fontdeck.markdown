...
- ![Typeface category page.](/media/projects/fontdeck/category.png "Exposing different means of discovery made it easier for users to browse Fontdeck’s catalogue."){.screenshot}
- ![Type specimen page.](/media/projects/fontdeck/specimen.png "Information about an individual typeface was available on one page, with meta data presented in the sidebar."){.screenshot}
  {.gallery}
