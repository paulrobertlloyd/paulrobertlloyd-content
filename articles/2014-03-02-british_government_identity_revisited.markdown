...
That the logo for GOV.UK, originally set in Gill Sans, now uses Transport is evidence that nothing is set in stone. I’m sure that as GOV.UK grows to encompass every facet of government, Transport will become the _de facto_ font face of state. Perhaps only then will Helvetica be supplanted, and I can write another blog post thanking civil servants for fulfilling a (design-related) wish.
...
[4]: /2009/271/a1/a_cohesive_and_unified_identity_for_british_government/
