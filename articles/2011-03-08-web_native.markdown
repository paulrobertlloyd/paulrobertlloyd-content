...
For much of its short existence, the web has been treated as if it were the printed page and you can see this is some of the terms we use — words such as _page_ — but also phrases like _above the fold_. Such misappropriation isn’t new. For example, during the early development of television, it was often referred to as “radio with pictures”.
