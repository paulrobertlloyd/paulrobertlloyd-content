...
The copyright statement on Apple’s website has long been named _sosumi_, a word that has [a nice little history inside Apple][17]. Until recently, the hamburger menu icon on ""The Guardian"" website was labelled _honest-burger_, after the developer’s favourite burger restaurant.
